...
0 6 * * * sightline cd /opt/reliefagent/current && /opt/reliefagent/current/venv/bin/python /opt/reliefagent/current/scripts/daily_ingest.py >> /var/log/reliefagent/daily-ingest.log 2>&1
EOF
...
30 6 * * 1 sightline cd /opt/reliefagent/current && /opt/reliefagent/current/venv/bin/python /opt/reliefagent/current/scripts/generate_bulletin.py --last-week >> /var/log/reliefagent/bulletin.log 2>&1
EOF
