...
class TestSITREPImports:
    ...
    def test_pipeline_imports(self):
        from sitrep.pipeline import _filter_hash, _safe_name, run_pipeline
...
class TestSITREPEndpoints:
    ...
    def test_run_requires_premium(self, client):
        ...
        resp = client.post("/api/sitrep/run", json={"country": "Sudan", "event": "Crisis"})
    ...
    def test_chunk_preview_requires_auth(self, client):
        ...
        resp = client.post("/api/sitrep/chunk-preview", json={"country": "Sudan"})
        assert resp.status_code in (200, 401, 403, 405)
...
class TestSITREPStreamNonce:
    ...
    def test_nonce_consume_valid(self):
        ...
        from blueprints.sitrep import _consume_stream_nonce, _create_stream_nonce
